...
\centering
\subfigure[Case $1$]{
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_1_left}
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_1_right}
}
\subfigure[Case $2$]{
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_2_left}
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_2_right}
}
\subfigure[Case $3$]{
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_3_left}
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_3_right}
}
\subfigure[Case $4$]{
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_4_left}
\includegraphics[width=0.2\textwidth]{figures/newcomparison/cut_new_example_4_right}
}
...
%\hline 
%case $2$ & $\mathbf{1}$ & 9ms& $9.956$ & $5/6541\approx0.08\%$\\
%\hline
...
An illustration of the test cases is shown in Fig.~\ref{fig:comparison}, whilst some relevant statistics %for comparison of the different cases 
...
%\item $\; \;$ Constant joint velocity is assumed, hence shortest-length joint-space is the fastest motion. 
\end{tablenotes}
\vspace{-0.5cm}
\end{table*}
...
${\rm 19.18rad^6}$. %, which are all the optimal one among the three tests. 
The average number of reconfigurations is shown to be $6.25$. When looking at the binned histogram, there is around a $70\%$ chance the sampling-based planner will generate a solution with $5\sim7$ reconfigurations. %, visualised in the bar chart. 
%\end{color} 
...
%\begin{color}{blue}
%It Moreover, note that the optimal number of reconfigurations is closely related but not the unique criterion to the optimal motion. 
%There may be motions that contain slightly more reconfigurations but shorter travelling distance, such as the ``random 3" result. 
%A trade-off can be naturally utilised by the users to choose the best solution. 
%\end{color}
...
%\end{color}
%It can be easily observed from our supplementary video how the undesirable motion calls for a large workcell and be time/energy inefficient. 
