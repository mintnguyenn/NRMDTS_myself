...
to dispensing with arising pertubations. %<jvm> Tong mental note: do we really do this? I asked you before, can't reacall
\end{enumerate}
...
\includegraphics[width=0.48\textwidth]{proof/equiv_cutting_path2_2}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.10\textwidth]{exp_semi_ellipsoid/casual_demo}}
\subfigure[]{\includegraphics[width = 0.10\textwidth]{exp_semi_ellipsoid/casual_comb}}
\subfigure[]{\includegraphics[width = 0.10\textwidth]{exp_semi_ellipsoid/casual_init_graph}}
\subfigure[]{\includegraphics[width = 0.10\textwidth]{exp_semi_ellipsoid/casual_result_graph}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.1\textwidth]{exp_semi_ellipsoid/design_demo}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{exp_semi_ellipsoid/design_comb}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{exp_semi_ellipsoid/design_init_graph}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{exp_semi_ellipsoid/design_result_graph}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.13\textwidth]{exp_pipe/demo}}
\subfigure[]{\includegraphics[width = 0.13\textwidth]{exp_pipe/init_graph}}
\subfigure[]{\includegraphics[width = 0.13\textwidth]{exp_pipe/result_graph}}
...
The manipulator ioperates as a 5DOF. %, which is non-redundant. 
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/no_obstacle_comb}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/no_obstacle_initial_graph}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/no_obstacle_result_graph}}
\subfigure[]{\includegraphics[width = 0.2\textwidth]{real_world_exp/no_obstacle_demo_1}\label{fig:real_free_extreme1}}
\subfigure[]{\includegraphics[width = 0.2\textwidth]{real_world_exp/no_obstacle_demo_2}\label{fig:real_free_extreme2}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_comb}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_initial_graph}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_result_graph}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_demo_1}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_demo_2}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{real_world_exp/with_obstacle_demo_3}}
...
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{author_pics/tongyang}}]{Tong Yang} 
...
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{author_pics/jaime_pic}}]
...
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{author_pics/qianenlai}}]{Qianen Lai}
...
\end{IEEEbiography}
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{author_pics/yuewang}}]{Yue Wang}
...
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{author_pics/rongxiong}}]{Rong Xiong}
