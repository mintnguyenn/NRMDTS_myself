...
The problem is tailored to a polishing task with the introduction of additional task-specific constraints, as per the motivation of this work. These could be waived for a more generic exercise. % <jvm> I omit intentionally, but could leave: resulting in wider topological search spaces.
...
%\caption{
%The elements of cells. All colors are indexed. Each cell corresponds to a connected area on the surface, and has a list of possible colors. A cell stores the index of its adjacet cell in order. % can you VERY briefly describe this for the example shown here, what numbers mean with respect to figure and the colours? e.g. for the middle cell, what is 2, 1, 3, using colours (blue, green, brown, cyan)
%%\textcolor{blue}{
...
%So it is suitable to show the distribution of a colour through drawing them on the mesh. For example, Fig.~\ref{flowchart} shows the distribution of four colors of the example in Fig.~\ref{figsquare}.
%
...
%These vertices belongs to a single cell. In Fig.~\ref{flowchart}, we draw a small circle filled in with multiple colors to show the possible colors for a cell. After repeating the process, all vertices are assigned. 
%
...
%
%Finally, the cell records the possible colors for covering the points and the index of its adjacet cells in order, see Fig.~\ref{figforcolor}. 
...
%
%After creating the topological graph, the original problem is equivalent to painting all points with one of their available colors, ensuring the minimum pieces of colors. And for a fully-filled graph, the colour of a point uniquely specifies one of the valid IK solutions to cover it. 
%\end{color}
...
%For example, in each subfigure of Fig.~\ref{figsquare}, the greyed out configurations have the same pose of the EE with the vivid one, so they must be assigned with different colors. 
...
%So the optimal cellular decomposition problem is transformed to the painting problem ensuring the minimum pieces of colors. 
...
\subfigure[Example shows that is is unnecesary to consider cutting paths that stretch across edges. 
]{
...
or the division is impossible %Fixed <jvm> Tong isn't this the premise for all 3-edge cell?? <ty> yes, and actually there is only one 3-edge cell. 
...
a set of cells with less edges, suitable to then be solved enumeratively as described. % for the simple cell case in the preceding section.
...
%\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
%\hline
%& \multicolumn{2}{c|}{Ours(with Spiral)} & \multicolumn{2}{c|}{Ours(with Boust.)} & \multicolumn{2}{c|}{Pure Spiral (10 average)} & \multicolumn{2}{c|}{Pure Boust. (10 average)}\\
%\cline{2-9}
%& Lift-offs & Time&Lift-offs & Time&Lift-offs & Time& Lift-offs & Time\\
%\hline
%\hline
%Hemisphere &2&2114.98+70.34& 2 & 3175.9+70.34 &34.6 &1503.3+35.26*34.6 &15.6 &3941.3+35.26*15.6\\
%\hline
%Half-pipe &1&820.09+29.98& 1 &840.75+29.98&32.2&1055.8+35.26*32.2&18.4&768.4+35.26*18.4\\
%\hline
%Vase &1&1345.15+35.26& 1&1101.47+35.26&30.4&2425.2+35.26*30.4&17.8&902.76+35.26*17.8\\
%\hline
%Full-pipe&1&1702.81+35.26&1&410.16+81.62&20.4&1548.5+35.26*20.4&16.1&1550.51+35.26*16.1\\
%\hline
%\end{tabular}
%\end{table*}
...
%\hline
% & \multicolumn{2}{c|}{Ours(with Boust.)} & \multicolumn{2}{c|}{Pure Spiral (10 average)} & \multicolumn{2}{c|}{Pure Boust. (10 average)}\\
%\cline{2-7}
%& Lift-offs & Time&Lift-offs & Time&Lift-offs & Time\\
%\hline
%\hline
%Hemisphere & 2 & 3175.9+70.34 &34.6 &1503.3+ &2.5 &3941.3+\\
%\hline
%Half-pipe & 1 &840.75+29.98&32.2&1055.8+&2.3&768.4+\\
%\hline
%Vase & 1&1101.47+35.26&30.4&2425.2+&1.8&902.76+\\
%\hline
%Klein bottle&3&924.47+81.62&85.4&3365+&58.8&3608.8+\\
%\hline
%\end{tabular}
%\begin{tablenotes}
%\item Time consumption = time for actual coverage + time when the EE is detached
%\end{tablenotes}
%\end{table*}

% spiral: hemisphere: 2114.98， half-pipe: 820.0897, vase: 1345.14923

%\begin{table*}[t]
%\centering
%\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
%\hline
% & \multicolumn{2}{c|}{Ours(with Boust.)} & \multicolumn{2}{c|}{Ours(with Spiral.)} & \multicolumn{2}{c|}{Pure Spiral (10 average)} & \multicolumn{2}{c|}{Pure Boust. (10 average)}\\
%\cline{2-9}
%& Lift-offs & Time&Lift-offs & Time&Lift-offs & Time&Lift-offs & Time\\
%\hline
%Hemisphere & 2 &(968.25+749.28+1458.4)+ (24.78+45.56)&1 & &36.6 &mean(1292.6, 1628.8, 1481.0, 1626.7, 1598.0, 1485.0, 1550.3, 1371.3, 1514.4, 1484.7) & 3.5& mean(3546.4*5+4336.1*5)\\
%\hline
%Half-pipe & 1 &(140.43+700.32)+&1&&&&&\\
%\hline
%Vase & 1&(370.95+730.52)+&1&&&&&\\
%\hline
%Klein bottle&3&(898.76+11.95+13.76)+&3&&&&&\\
%\hline
%\end{tabular}
%\end{table*}
...
\subfigure[]{\includegraphics[width = 0.2\textwidth]{figures/real_world_exp/no_obstacle_demo_1}\label{fig:real_free_extreme1}}
\subfigure[]{\includegraphics[width = 0.2\textwidth]{figures/real_world_exp/no_obstacle_demo_2}\label{fig:real_free_extreme2}}
...
\subfigure[]{\includegraphics[width = 0.14\textwidth]{figures/real_world_exp/with_obstacle_demo_1}}
\subfigure[]{\includegraphics[width = 0.14\textwidth]{figures/real_world_exp/with_obstacle_demo_2}}
...
\begin{figure}[t]
\centering
%\includegraphics[width = 0.09\textwidth]{figures/simu_exp/exp_assembly_line/1}
\subfigure[Illustration of the polishing task using a single manipulator, where an undesirable transformation of robot's configuration is required.\textcolor{red}{(Have not finish)}]{
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/2}
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/3}
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/4}
}\label{figtaska}
\subfigure[Illustration of the polishing task using two manipulators. ]{
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/2}
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/3}
\includegraphics[width = 0.14\textwidth]{figures/simu_exp/exp_assembly_line/4}
}\label{figtaskb}
...
\end{color}
%\subsection{Covering Objects of Arbitrary Shapes}
%\label{sec:other_sim_examples}
...
%(a) Reachable coloured cells of three valid configuration, chosed by the solution in (c). 
%(b) Topological graph. (c) One of the optimal solutions, requiring 2 lift-offs. 
%(d),(e),(f) Example of the three kinds of configurations, where
%(d) Example of the shoulder-left configuration adopted to avoid collision between the upper-arm and the obstacle. 
%(e) Example of the wrist above the fore-arm configuration, so that the wrist avoids colliding with the fore-arm. 
...
Fig.~\ref{fig_realworld_no} illustrates the results. Given the location of the wok, it can be seen how the nearest %and farthest 
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.11\textwidth]{figures/real_world_exp/with_obstacle_comb}}
\subfigure[]{\includegraphics[width = 0.11\textwidth]{figures/real_world_exp/with_obstacle_initial_graph}}
\subfigure[]{\includegraphics[width = 0.11\textwidth]{figures/real_world_exp/with_obstacle_result_graph}}
\subfigure[]{\includegraphics[width = 0.11\textwidth]{figures/real_world_exp/with_obstacle_demo_1}}
\caption{\textcolor{blue}{Example of polishing a cube. }
%(a) Reachable coloured cells of three valid configuration, chosed by the solution in (c). 
%(b) Topological graph. (c) One of the optimal solutions, requiring 2 lift-offs. 
%(d),(e),(f) Example of the three kinds of configurations, where
%(d) Example of the shoulder-left configuration adopted to avoid collision between the upper-arm and the obstacle. 
...
\bibliography{min_removal_revision_Tong}
...
\begin{IEEEbiography}[{\includegraphics[width=1.1 in,height=1.25 in,clip,keepaspectratio]{figures/author_pics/tongyang}}]{Tong Yang} 
