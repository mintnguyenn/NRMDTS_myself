...
\author{Tong Yang$^1$~\IEEEmembership{Student Member,~IEEE}, Jaime Valls Miro$^2$~\IEEEmembership{Member,~IEEE}, Qianen Lai$^1$,\\ Yue Wang$^{1*}$~\IEEEmembership{Member,~IEEE} and Rong Xiong$^1$~\IEEEmembership{Member,~IEEE}
...
\includegraphics[width = 0.18\textwidth]{figures/other_figures/greedy}
\label{fig:greedy}
}
\subfigure[Optimal solution example]{
\includegraphics[width = 0.18\textwidth]{figures/other_figures/optimal}
\label{fig:optimal}
}
...
\includegraphics[width=0.39\textwidth]{figures/proof/equiv_cutting_path}}
...
\includegraphics[width=0.44\textwidth]{figures/proof/equiv_cutting_path2_2}}
\subfigure[Example shows that intersecting cutting paths can be discarded.]{
\includegraphics[width = 0.44\textwidth]{figures/proof/equiv_cutting_path3}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/simu_exp/exp_pipe/demo}} \qquad
\subfigure[]{\includegraphics[width = 0.08\textwidth]{figures/simu_exp/exp_pipe/init_graph}} \qquad
\subfigure[]{\includegraphics[width = 0.08\textwidth]{figures/simu_exp/exp_pipe/result_graph}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.1\textwidth]{figures/simu_exp/exp_fullpipe/color_comb}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{figures/simu_exp/exp_fullpipe/init_graph}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{figures/simu_exp/exp_fullpipe/result_graph}}
\subfigure[]{\includegraphics[width = 0.1\textwidth]{figures/simu_exp/exp_fullpipe/demo_comb}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/no_obstacle_comb}}
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/no_obstacle_initial_graph}}
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/no_obstacle_result_graph}}
...
\begin{figure}[t]
\centering
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/with_obstacle_comb}}
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/with_obstacle_initial_graph}}
\subfigure[]{\includegraphics[width = 0.12\textwidth]{figures/real_world_exp/with_obstacle_result_graph}}
...
\bibliography{IEEEabrv,min_removal_revision2}
