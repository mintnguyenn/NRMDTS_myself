...
\section{Introduction and Related Work}\label{section_introduction}
...
\begin{figure}[t]
\centering
\subfigure[For an illustration of a concrete coverage task of a planar rectangular region, s(houlder)-l(eft)\&w(rist)-f(lipped), s-r(ight)\&w-u(nflipped), s-r\&w-f, and s-l\&w-u configurations are depicted, between each pair of whom there must exist a singular configuration preventing them being continuously traversed by the manipulator. Representing disconnectable manipulator configurations into different colours, abstract topological graph with task-specified colour distributions is constructed as shown below, as the input of the NCPP problem. ]{
\includegraphics[width = 0.11\textwidth]{figures/tmech_figures/slwf}
\includegraphics[width = 0.11\textwidth]{figures/tmech_figures/srwu}
\includegraphics[width = 0.11\textwidth]{figures/tmech_figures/srwf}
\includegraphics[width = 0.11\textwidth]{figures/tmech_figures/slwu}
}
\subfigure[A toy illustration of the problem arising when planning optimal non-revisiting coverage paths with a manipulator: valid robot configurations form disjoint sets in joint-space, while their task-space FK mapping images (end-effector poses) may overlap. 
...
\begin{figure}[t]
\centering
\subfigure[Cell sub-divisions after graph separation. One sub-cell will have four adjacent cells. ]{
\includegraphics[width=0.225\textwidth]{figures/constraint_violation_a_2}
}
\subfigure[Graph separation after cell sub-divisions.]{
\includegraphics[width=0.225\textwidth]{figures/constraint_violation_b_2}
}
