...
%An example of this is illustrated in \ref{fig:many_to_one} . 
...
\end{aligned}
\end{equation}
If cell $13$ and cell $19$ are of same colour, then the cost of the combined graph is one less than the sum of the individual cost of each of the strips. 
