...
X = global_ori_ver(:, 1);
Z = global_ori_ver(:, 3);
global_ori_ver(:, 1) = X*cos(50/180*pi) - Z*sin(50/180*pi);
global_ori_ver(:, 3) = X*sin(50/180*pi) + Z*cos(50/180*pi);

global_ori_ver(:, 1) = global_ori_ver(:, 1)+0.7;
global_ori_ver(:, 2) = global_ori_ver(:, 2)+0.1;
global_ori_ver(:, 3) = global_ori_ver(:, 3) + 0.08;
